...
aliases: 
- /2017/01/10/openstack-migrate-keystone-endpoint-url/
---
...
{{< figure src="/images/MigrateOpenstackKeystoneUrl/before.png" title="Old API access settings" >}}
...
{{< figure src="/images/MigrateOpenstackKeystoneUrl/after.png" title="New API access settings" >}}
